...
- **[RESOLVED]** Add lightweight contract checks in CI for key DTO payloads: `StampDto`, `FirstDayCoverDto`, `TariffsDto` — enforced via `api.generated.ts` drift check in CI.
