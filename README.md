...
eCollecto is a Ukrainian stamp collection application — a React/Vite SPA backed by a Spring Boot + MongoDB API. Browse stamps, first-day covers, and postal tariff data. Authenticated users can access their personal profile via a Keycloak-secured endpoint.
...
| [`KNOWN_ISSUES.md`](KNOWN_ISSUES.md) | Known code issues and prioritized fixes (all resolved) |
